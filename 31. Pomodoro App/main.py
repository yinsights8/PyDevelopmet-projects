...
# labels
timer_label = Label(text="Timer", fg=GREEN, bg=YELLOW, font=(FONT_NAME, 23, "bold"))
timer_label.grid(column=0, row=0)

# check Mark
check_label = Label(bg=YELLOW, fg=GREEN)
check_label.place(x=100, y=270)
# check_label.grid(column=1, row=3)

# Canvas
canvas = Canvas(width=200, height=224, bg=YELLOW, highlightthickness=0)
tomato_png = PhotoImage(file="tomato.png")
# x,y are the coordinates of the canvas which is Half of the canvas
